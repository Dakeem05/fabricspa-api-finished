...
<head>
    ...
    <title>Reminder: Items in Your Cart</title>
...
<body>
    <div class="container">
        ...
        <p class="reminder-text">
            Just a friendly reminder that you have <strong>{{ $cartItemCount }}</strong> item(s) in your cart. Complete your purchase and enjoy your fabulous finds!
        </p>
