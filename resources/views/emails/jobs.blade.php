...
<body>
    <div class="container">
        ...
        <p class="reminder-text ">
            {{-- {{$main}} --}}
            There is a new job listing of <strong>{{$title}}</strong> with pay of <strong>{{$pay}}</strong>. Please check it out.
        </p>
        <!-- Add additional promotional content or links here -->
        <a href="https://fabricspa.com.ng/career" class="cta-button">Check out our careers</a>
        <p class="signature">
            The FabricSPA Team
        </p>
    </div>
